        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-xl font-bold text-slate-900 tracking-tight">Chỉnh sửa Variant</h1>
            </div>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="p-6">
              <div className="flex items-start gap-5">
                {imagePreview ? (
                  ...
                  <label className="relative flex flex-col items-center justify-center w-40 h-40 rounded-2xl border-2 border-dashed border-slate-200 bg-gradient-to-br from-slate-50 to-slate-100/50 cursor-pointer hover:border-amber-300 hover:from-amber-50/50 hover:to-amber-50 transition-all duration-300 group">
                    <div className="h-12 w-12 rounded-2xl bg-white border border-slate-200 flex items-center justify-center shadow-sm mb-2.5 group-hover:scale-110 group-hover:shadow-md transition-all duration-300">
                      <ImagePlus size={20} className="text-slate-300 group-hover:text-amber-400 transition-colors duration-300" />
                    </div>
                    <span className="text-[11px] font-semibold text-slate-400 group-hover:text-amber-500 transition-colors duration-300">Đổi ảnh</span>
          ...
          <div className="flex gap-3 pt-1 pb-6">
            ...
            <button type="submit" disabled={isLoading}
              ...
              {isLoading
                ? <><Loader2 size={15} className="animate-spin" />{isUploading ? "Đang upload ảnh..." : "Đang cập nhật..."}</>
                : <><PencilLine size={14} />Lưu thay đổi</>
              }
            </button>
          </div>
        </form>
