        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-xl font-bold text-slate-900 tracking-tight">Cập nhật thông tin kho</h1>
            </div>
            <p className="text-xs text-slate-400 mt-0.5 ml-6">Chỉnh sửa thông tin kho trong hệ thống</p>
          </div>
          <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-emerald-50 border border-emerald-200">
            <div className="h-1.5 w-1.5 rounded-full bg-emerald-500 animate-pulse" />
            <span className="text-[11px] font-semibold text-emerald-600">Chỉnh sửa</span>
          </div>
        </div>

        {isLoadingWarehouse && (
          <div className="rounded-2xl border border-slate-100 bg-white px-6 py-8 text-center text-sm text-slate-500 mb-4">
