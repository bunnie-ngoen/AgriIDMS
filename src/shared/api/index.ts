...
export const api = createApi({
    ...
    tagTypes: ["Profile", "Supplier", "Category", "Product", "Zone", "Rack", "Slot", "SlotContents", "User", "ProductVariant", "PurchaseOrder", "GoodsReceipt", "Cart", "Notification", "StockCheck", "Warehouse", "Lot", "DamageReport"],
    endpoints: () => ({})
});